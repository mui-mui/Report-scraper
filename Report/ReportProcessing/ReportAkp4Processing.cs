...
{
    [ReportHandlerAttibute(ReportName = "АКП-4")]
    class ReportAkp4Processing : AkpReportProcessing
    {
        protected override DateTime StartDay { get; }
        protected override DateTime EndDate { get; }

        public ReportAkp4Processing(DateTime startDay, DateTime endDate)
        {
            StartDay = startDay;
            EndDate = endDate;
        }
